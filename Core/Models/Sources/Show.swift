...
public struct Show: Item, StorageItem {
    ...
    public var episodeRunTime: [Minutes]
...
extension Show: Mergeable {
    public func merging(_ newValue: Show) -> Show {
...
extension Show {
    public var typeText: String { type.isEmpty ? "-" : type }
}
