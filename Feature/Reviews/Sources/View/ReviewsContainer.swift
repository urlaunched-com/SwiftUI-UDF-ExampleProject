...
public struct ReviewsContainer<F: ReviewsFeature, R: Routing>: BindableContainer where R.Route == ReviewsRoute {
    public typealias ContainerComponent = ReviewsComponent<R>
